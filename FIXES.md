...
1. Create a new file called `ArtisanProfile.tsx` with the following content:
...
2. In the Artisan interface (in services/artisans.ts), add the following fields to the businessInfo interface:
...
3. Replace the content of your existing ArtisanProfile.tsx with the content above.

These changes will:
1. Fix all the JSX structure issues
2. Properly type all the used fields
3. Add proper error handling and loading states
4. Improve the component organization with extracted render methods
5. Fix the ScrollArea implementation
6. Add proper TypeScript type definitions